...
#define DETOUR_TRAMPOLINE_SIGNATURE             0x21727444  
...
__declspec(align(16)) struct DETOUR_IA64_BUNDLE
{
  ...
  protected:
    ...
    static UINT64 GetOpcode(UINT64 instruction); 
    static UINT64 GetX(UINT64 instruction); 
    static UINT64 GetX3(UINT64 instruction); 
    static UINT64 GetX6(UINT64 instruction); 
